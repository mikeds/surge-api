...
class Internal_service_accounts_model extends CI_Model {
	private 
		$_table	= 'internal_service_accounts  internal_service_accounts',
		$_table_x	= 'internal_service_accounts';

	private
		$_id = "isaccount_number";
